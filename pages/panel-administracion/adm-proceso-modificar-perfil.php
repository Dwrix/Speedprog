...
if($tipo != '4'){
    ...
    if($passwordUsuario != null){
        ...
        password = '$md5passwordUsuario', fecha_nacimiento = '$fechaUsuario', direccion = '$direccionUsuario', id_pais_fk = '$regPais[0]', mail_paypal = '$mailPayPal' WHERE id_usuario='$idUsuario'";
    ...
    $sqlUpdate1 = "UPDATE usuario SET rut = '$rutUsuario', nombre = '$nombreUsuario', correo = '$mailUsuario', fecha_nacimiento = '$fechaUsuario', direccion = '$direccionUsuario', id_pais_fk = '$regPais[0]', mail_paypal = '$mailPayPal' WHERE id_usuario='$idUsuario'";
    $registrosUpdate1 = mysqli_query($conexion, $sqlUpdate1) or die("Problemas en la seleccion update solicitud:" . mysqli_error($conexion));
