...
;(function ( $, window, document, undefined ) {
    ...
    $.widget( "namespace.strength_meter" , {
        ...
        options: {
            ...
            hidePasswordText: 'Esconder Contraseña'
        },
        ...
        _create: function () {
            ...
            this.element.append('<input type="password" id="pass" name="pass1" placeholder="Ingrese Contraseña" class="' + options.inputClass + '" "/>');
            ...
            this.element.append(
                ...
                <h4>Contraseña debe incluir:</h4> \
                <ul> \
                <li data-criterion="length" class="valid">8-20 <strong>Caracteres</strong></li> \
                <li data-criterion="capital" class="valid">Al menos <strong>una letra mayús</strong></li> \
        ...
        _update_indicator: function(total) {
            ...
            if (total === 0) {
                ...
                meter.addClass('veryweak').html('<p>Muy debil</p>');
            } else if (total === 2) {
                meter.addClass('weak').html('<p>Débil</p>');
            } else if (total === 3) {
                meter.addClass('medium').html('<p>Medio</p>');
            } else {
